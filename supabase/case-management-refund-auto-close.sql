-- =============================================================================
-- Equipd Case Management — Refund completion auto-closes case
-- =============================================================================
--
-- When an admin marks a refund completed, the case is closed in the same step.
-- Manual "Close case" remains for non-refund outcomes only.
--
-- Prerequisites: case-management-phase3-refund-closure.sql
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- Active case helpers — refund_completed is no longer a long-lived state
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- admin_mark_dispute_refund_completed — completes refund and closes case
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- admin_mark_support_refund_completed — completes refund and closes case
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- admin_close_dispute_case — manual close for non-refund outcomes only
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- admin_close_support_case — manual close for non-refund outcomes only
-- ---------------------------------------------------------------------------
