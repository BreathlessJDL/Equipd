-- Hide active Bubble import listings with zero images from public browse/detail.
-- Future imports without images are hidden until listing_images exist.
-- Permanent cleanup: supabase/delete-zero-image-import-listings.sql
...
comment on function public.listing_is_publicly_visible(public.listings) is
  'True when an active listing is browsable by the public. Import listings need at least one image.';
...
-- ---------------------------------------------------------------------------
-- listing_images SELECT policy (keep offer + seller exceptions)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Distance browse RPC (explicit filter; security invoker + RLS)
-- ---------------------------------------------------------------------------
